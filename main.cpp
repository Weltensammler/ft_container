...
/*   Updated: 2023/02/13 16:18:16 by bschende         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	std::cout << " - " << it[2] << std::endl;
// 	ft::vector<std::string>::iterator comp = vec.begin();
// 	ft::vector<std::string>::const_iterator comp1 = vec.begin();
// 	if (comp == comp1)
// 		std::cout << "Comparing iterator with const_iterator SUCCESS" << std::endl;
// 	else
// 		std::cout << "Comparing iterator with const_iterator FAILED" << std::endl;
...
// 	vct3.insert(vct3.end(), 42);
// 	std::cout << "Vector size" << std::endl;
// 	std::cout << " - " << vct3.size() << std::endl;
// 	std::cout << "Vector capacity" << std::endl;
// 	std::cout << " - " << vct3.capacity() << std::endl;
// 	it3 = vct3.begin();
// 	for (; it3 != vct3.end(); it3++)
// 		std::cout << " - " << *it3 << std::endl;
// 	vct3.insert(vct3.begin(), 2, 21);
// 	std::cout << "Vector size" << std::endl;
// 	std::cout << " - " << vct3.size() << std::endl;
// 	std::cout << "Vector capacity" << std::endl;
// 	std::cout << " - " << vct3.capacity() << std::endl;
